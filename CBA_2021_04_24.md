...
```
51. This platform is deprecated due to STM32 shortages and OLED reliability issues. We have moved to a RP2040 platform.
52. Both BOOT jumpers are on the 0 side (versus 1).   
...
53. J Headers - isolation of many components is possible, note that uSD disconnect is simply removing the card:   
